...
INSERT INTO tour(nom,cout) VALUES
('poussifeu',0),
('granivol',0),
('magneti',8),
('salameche',15),
...
('deflagration','le pokemon emmet une onde autour de lui qui inflige d important degats au ennemi dans sa portee'),
('onde electrique','le pokemon emmet une onde electrique qui immobilise les ennemis dans sa portee'),
('poisson efficace','le pokemon renfoce son venin pour ralentir tout les ennemis qu il a empoissonee auparavant');

INSERT INTO detailEffet(nom_effet,description) VALUES
('poisson', 'un ennemi touchet par cette effet recoi un certain nombre de degats selon une frequence pendant un certain nombre de temps'),
